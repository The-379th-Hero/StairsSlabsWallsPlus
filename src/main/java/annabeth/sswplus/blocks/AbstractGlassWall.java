...
public abstract class AbstractGlassWall extends WallBlock {
	public AbstractGlassWall(Block block) {
		super(AbstractBlock.Properties.copy(block).noOcclusion().isValidSpawn(SSWPBlocks::never).isRedstoneConductor(SSWPBlocks::never).isSuffocating(SSWPBlocks::never).isViewBlocking(SSWPBlocks::never));
	}
